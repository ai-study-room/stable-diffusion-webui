...
parser.add_argument("--skip-torch-npu-test", action='store_true', help="launch.py argument: do not check if NPU is able to work properly")
...
parser.add_argument("--device-id", type=str, help="Select the default NPU device to use (export NPU_VISIBLE_DEVICES=0,1,etc might be needed before)", default=None)
